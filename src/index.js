...
document
  .getElementById("chronometer-button")
  .addEventListener("click", mainInner);
document
  .getElementById("alarm-button")
  .addEventListener("click", clearScreenAlarm);
